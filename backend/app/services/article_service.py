...
def create_article(db: Session, *, title: str, content_md: str, author_id: int, tags: Optional[List[str]] = None) -> Article:
    article = Article(title=title, content_md=content_md, author_id=author_id, summary=content_md[:180])
